...
if($row = mysqli_fetch_assoc($checkExpertise)){
    ...
    if(strpos($expertise, 'Programming') !== false){
        $canEdit = true;
    }
}

$query = mysqli_query($conn,
"SELECT * FROM chapters WHERE subject='Programming'"
);
?>
...
<div class="container">
    ...
    <aside class="sidebar">
        <h2 onclick="location.href='subjects.php'">
            <i class="fas fa-arrow-left" style="font-size:18px;"></i> Programming
        </h2>

        <?php if($canEdit){ ?>
        <button class="add-btn" onclick="location.href='addChapter.php?subject=Programming'">
        ...
        <div class="chapter">
            <div class="chapter-header" onclick="toggleChapter(this)">
                ...
                <div style="display:flex; align-items:center; gap:8px;">
                    ...
                    <?php if($canEdit){ ?>                
                    <a href="deleteAll.php?type=chapter&id=<?php echo $row['chapter_id']; ?>&subject=Programming"
            ...
            <ul class="chapter-content">
                ...
                <li onclick="loadTopic(<?php echo $topic['topic_id']; ?>, this)">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div style="display:flex; align-items:center; gap:6px;">
                            ...
                            <?php if($canEdit){ ?>
                            <a href="addResource.php?topic_id=<?php echo $topic['topic_id']; ?>&subject=Programming"
                               onclick="event.stopPropagation()"
                               style="color:#1f3f98; font-size:11px;">
                                <i class="fas fa-plus"></i>
                            </a>
                            <a href="deleteAll.php?type=topic&id=<?php echo $topic['topic_id']; ?>&subject=Programming"
                ...
                <li style="text-align:center; background:transparent; cursor:default;">
                    <a href="addTopic.php?chapter_id=<?php echo $row['chapter_id']; ?>&subject=Programming"
                       onclick="event.stopPropagation()"
