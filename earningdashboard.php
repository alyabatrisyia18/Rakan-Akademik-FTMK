...
<div class="card"><h3>Total Sessions</h3><p><?php echo $totalSession;?></p></div>
<div class="card"><h3>Total Hours</h3><p><?php echo $totalHours;?></p></div>
<div class="card"><h3>Rate / Hour</h3><p>RM <?php echo $rate;?></p></div>
<div class="card"><h3>Total Earnings</h3><p>RM <?php echo number_format($totalEarning,2);?></p></div>
</div>
...
<td><button class="approved"><?php echo $row['approvalStatus'];?></button></td>
</tr>
<?php } ?>

<tr class="total-row">
<td colspan="4">Total Earnings</td>
<td colspan="2">RM <?php echo number_format($totalEarning,2);?></td>
</tr>
</table>
</div>
</body>
